...
public class ResourceDatabasePopulator implements DatabasePopulator {
	...
	/**
	 * Create a new {@code ResourceDatabasePopulator} with the supplied values.
	 * @param continueOnError flag to indicate that all failures in SQL
	 * should be logged but not cause a failure
	 * @param ignoreFailedDrops flag to indicate that a failed SQL
	 * {@code DROP} statement can be ignored
	 ...
	 * @param scripts the scripts to execute to initialize or clean up the
	 * database, must not be {@code null}
	 */
	 ...
	 * @param script the path to an SQL script, must not be {@code null}
	 */
	 ...
	 * @param scripts the scripts to execute, must not be {@code null}
	 */
	...
	/**
	 * Specify the encoding for the configured SQL scripts, if different
	 * from the platform encoding.
	 ...
	 * <p>The default is {@literal false} so that if the populator runs accidentally,
	 * it will fail fast if a script starts with a {@code DROP} statement.
	 ...
	 * @param connectionFactory the {@link ConnectionFactory} to execute against, must not be {@code null}
