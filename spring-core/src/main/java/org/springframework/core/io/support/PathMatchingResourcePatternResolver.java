...
public class PathMatchingResourcePatternResolver implements ResourcePatternResolver {
	...
	/**
	 * 重写了getResource方法，支持 ResourceLoader 和 ResourcePatternResolver 新增的 "classpath*:" 前缀。
	 * 还支持 Ant 风格的路径匹配模
	...
	protected String determineRootDir(String location) {
		...
		// 举例：例如原路径：classpath*:test/cc*/spring-*.xml   ------> 确定根路径：classpath*:test/
		// 例如原路径：classpath*:test/aa/spring-*.xml  ------> classpath*:test/aa/
	}
