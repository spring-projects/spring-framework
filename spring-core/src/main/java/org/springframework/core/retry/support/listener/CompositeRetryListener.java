...
public class CompositeRetryListener implements RetryListener {
	...
	public void beforeRetry() {
		this.listeners.forEach(RetryListener::beforeRetry);
	}

	@Override
	public <T> void onSuccess(T result) {
		this.listeners.forEach(listener -> listener.onSuccess(result));
	}

	@Override
	public void onFailure(Exception exception) {
		this.listeners.forEach(listener -> listener.onFailure(exception));
	}

	@Override
	public void onMaxAttempts(Exception exception) {
		this.listeners.forEach(listener -> listener.onMaxAttempts(exception));
	}
