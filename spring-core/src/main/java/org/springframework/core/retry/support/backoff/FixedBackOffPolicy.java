...
/**
 * A {@link BackOffPolicy} that is fixed to a configurable duration (defaults to 1 second).
 *
...
public class FixedBackOffPolicy implements BackOffPolicy {
	...
	/**
	 * Create a new {@link FixedBackOffPolicy} with a specific duration.
	 * @param duration the fixed backoff duration
	 */
