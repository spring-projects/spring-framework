...
abstract class AbstractStaxHandler implements ContentHandler, LexicalHandler {
	...
	public final void startDocument() throws SAXException {
		...
		try {
			...
			throw new SAXException("Could not handle startDocument: " + ex.getMessage(),
					ex);
		}
	}
	...
	public final void endDocument() throws SAXException {
		...
		try {
			...
			throw new SAXException("Could not handle endDocument: " + ex.getMessage(),
					ex);
		}
	}
	...
	public final void startElement(String uri, String localName, String qName,
		...
		try {
			...
			throw new SAXException("Could not handle startElement: " + ex.getMessage(),
					ex);
		}
	}
	...
	protected abstract void ignorableWhitespaceInternal(String data)
	...
	public final void skippedEntity(String name) throws SAXException {
		try {
			...
			throw new SAXException("Could not handle skippedEntity: " + ex.getMessage(),
					ex);
		}
	}
