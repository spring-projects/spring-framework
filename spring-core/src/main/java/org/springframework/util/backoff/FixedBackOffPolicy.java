...
public class FixedBackOffPolicy implements BackOffPolicy {
	...
	/**
	 * Create an instance with the given interval and an unlimited number
	 * of attempts.
	 * @param interval the interval between two attempts
	 */
	public FixedBackOffPolicy(long interval) {
		this(interval, UNLIMITED_ATTEMPTS);
	}
	 ...
	 */
	public FixedBackOffPolicy(long interval, long maxAttempts) {
	...
	private class FixedBackOffExecution implements BackOffExecution {
		...
		public String toString() {
			String attemptValue = (FixedBackOffPolicy.this.maxAttempts == Long.MAX_VALUE ?
					"unlimited" : String.valueOf(FixedBackOffPolicy.this.maxAttempts));
			return "FixedBackOff{interval=" + FixedBackOffPolicy.this.interval +
