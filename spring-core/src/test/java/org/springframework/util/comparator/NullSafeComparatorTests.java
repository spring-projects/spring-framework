...
public class NullSafeComparatorTests {
	...
	@Test
	public void shouldCompareWithNullsLowStatic() {
	...
	@SuppressWarnings("unchecked")
	@Test
	public void shouldCompareWithNullsHighStatic() {
	...
	public void shouldCompareWithNullsLow() {
		Comparator<String> c = NullSafeComparator.nullsLow();
		assertTrue(c.compare(null, "boo") < 0);
	}

	@Test
	public void shouldCompareWithNullsHigh() {
		Comparator<String> c = NullSafeComparator.nullsHigh();
		assertTrue(c.compare(null, "boo") > 0);
		assertTrue(c.compare(null, null) == 0);
	}
}
