...
public class GenericTypeResolverTests {
	...
	public void parameterizedMethodReturnTypes() {
		...
		// TODO Determine if it's possible to infer the following type.
		//
		// Ideally we would expect String.class instead of Object.class.
		//
		...
		// TODO Determine if it's possible to infer the following type.
		//
		// Ideally we would expect Boolean.class instead of Object.class.
		//
