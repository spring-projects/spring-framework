...
class JmsNamespaceHandlerTests {
	...
	@Test
	void jcaContainerConfiguration() {
	...
	@Test
	void jmsContainerFactoryConfiguration() {
	...
	@Test
	void jcaContainerFactoryConfiguration() {
