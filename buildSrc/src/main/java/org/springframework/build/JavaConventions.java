...
public class JavaConventions {
   ...
   *
   * <p>NOTE: If you update this value, you should also update the value used in the {@code javadoc}
    ...
    project.afterEvaluate(
        p -> {
          ...
          p.getTasks()
              ...
              .matching(
                  compileTask ->
                      compileTask.getName().startsWith(JavaPlugin.COMPILE_TEST_JAVA_TASK_NAME)
