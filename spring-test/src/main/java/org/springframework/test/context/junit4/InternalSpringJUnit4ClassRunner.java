...
/**
 * <p>
 * {@code InternalSpringJUnit4ClassRunner} is where the real stuff happens.
 * {@link SpringJUnit4ClassRunner} delegates either directly, or indirectly 
 * through {@link SpringJUnit4ParameterizedClassRunner}, to this class.
 *
 * @author Sam Brannen
...
class InternalSpringJUnit4ClassRunner extends BlockJUnit4ClassRunner {

	private static final Log logger = LogFactory.getLog(InternalSpringJUnit4ClassRunner.class);

	private final TestContextManager testContextManager;


	/**
	 * Constructs a new {@code InternalSpringJUnit4ClassRunner} and initializes a
	 * {@link TestContextManager} to provide Spring testing functionality to
	 * standard JUnit tests.
	 * @param clazz the test class to be run
	 * @see #createTestContextManager(Class)
	 */
	public InternalSpringJUnit4ClassRunner(Class<?> clazz) throws InitializationError {
		super(clazz);
