...
public class ReflectionTestUtilsTests {
	...
	public void setAndGetStandardFields() {
		...
		assertEquals("'likes pets' flag (package private boolean field)", true,
				person.likesPets());
	...
	public void invokeSetterAndGetterMethodStandandProperties() {
		...
		assertEquals("'likes pets' flag (protected method for a boolean)", true,
				person.likesPets());
		assertEquals("'favorite number' (protected method for a Number)", PI,
	...
	public void invokeSetterAndGetterMethodStandandMethods() {
		...
		assertEquals("'likes pets' flag (protected method for a boolean)", false,
				person.likesPets());
		assertEquals("'favorite number' (protected method for a Number)",
	...
	public void invokeSetterAndGetterMethodNonPrivateProperty() {
		...
		assertNull("'favorite number' (protected method for a Number)",
				person.getFavoriteNumber());
	}
	...
	public void invokeMethodsSimulatingLifecycleEvents() {
		...
		assertEquals("number should have been configured", new Integer(42),
				component.getNumber());
