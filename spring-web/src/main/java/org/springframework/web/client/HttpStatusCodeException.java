...
import org.springframework.web.client.support.ExceptionMessageExtractor;
...
public abstract class HttpStatusCodeException extends RestClientResponseException {
	...
	protected HttpStatusCodeException(HttpStatus statusCode, String statusText,
		...
		this(statusCode, statusText, responseHeaders, responseBody, responseCharset, null, null);
	}
	...
	protected HttpStatusCodeException(HttpStatus statusCode, String statusText,
		...
		super(ExceptionMessageExtractor.getExceptionMessage(statusCode, statusText, responseBody, responseCharset, url, method),
				statusCode.value(), statusText, responseHeaders, responseBody, responseCharset, url, method);
