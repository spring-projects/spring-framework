 ...
 * particular {@link org.springframework.context.annotation.Configuration @Configuration}-annotated
 * classes, but also plain {@link org.springframework.stereotype.Component @Component}
 * classes and JSR-330 compliant classes using {@code javax.inject}
 * annotations. Allows for registering classes one by one (specifying class names as
 * config location) as well as for classpath scanning (specifying base packages as config
 * location).
 *
...
public class AnnotationConfigEmbeddedWebApplicationContext extends EmbeddedWebApplicationContext {
	...
	/**
	 * Create a new {@link AnnotationConfigEmbeddedWebApplicationContext} that needs to be populated
	...
	/**
	 * Create a new {@link AnnotationConfigEmbeddedWebApplicationContext}, deriving bean definitions
	...
	/**
	 * Create a new {@link AnnotationConfigEmbeddedWebApplicationContext}, scanning for bean definitions
