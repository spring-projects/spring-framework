...
public class ServletRegistrationBean extends RegistrationBean {
	...
	/**
	 * Set the URL mappings for the servlet. If not specified the mapping will default
	 * to '/'. This will replace any previously specified mappings.
	...
	public void onStartup(ServletContext servletContext) throws ServletException {
		...
		for (Filter filter : this.filters) {
			FilterRegistrationBean filterRegistration = new FilterRegistrationBean(filter, this);
