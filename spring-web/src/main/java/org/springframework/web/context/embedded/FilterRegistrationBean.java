...
public class FilterRegistrationBean extends RegistrationBean {
	...
	private Set<ServletRegistrationBean> servletRegistrationBeans =
			new LinkedHashSet<ServletRegistrationBean>();
	...
	/**
	 * Set servlet names that the filter will be registered against. This will replace
	 * any previously specified servlet names.
