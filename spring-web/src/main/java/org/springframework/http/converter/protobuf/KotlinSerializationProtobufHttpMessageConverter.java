 ...
 * @since 5.3
 */
public class KotlinSerializationProtobufHttpMessageConverter extends KotlinSerializationBinaryHttpMessageConverter {
	/**
	...
	public KotlinSerializationProtobufHttpMessageConverter(final ProtoBuf protobuf) {
		super(protobuf, MediaType.APPLICATION_X_PROTOBUF, MediaType.APPLICATION_OCTET_STREAM, MediaType.APPLICATION_VND_GOOGLE_PROTOBUF);
	}
}
