...
public class ContentDisposition {
	...
	private static String decodeHeaderFieldParam(String input) {
		...
		Assert.state(StandardCharsets.UTF_8.equals(charset) || StandardCharsets.ISO_8859_1.equals(charset),
				"Charset should be UTF-8 or ISO-8859-1");
		...
		while (index < value.length) {
			...
			if (isRFC5987AttrChar(b)) {
				...
				throw new IllegalStateException("Invalid header field parameter format (as defined in RFC 5987)");
			}
		}
