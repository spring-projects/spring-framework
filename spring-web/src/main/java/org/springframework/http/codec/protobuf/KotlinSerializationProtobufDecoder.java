 ...
 * @since 5.3
 */
public class KotlinSerializationProtobufDecoder extends KotlinSerializationBinaryDecoder {

	public KotlinSerializationProtobufDecoder() {
		this(ProtoBuf.Default);
	}

	public KotlinSerializationProtobufDecoder(final ProtoBuf protobuf) {
		super(protobuf, ProtobufCodecSupport.MIME_TYPES.toArray(new MimeType[0]));
	}
}
