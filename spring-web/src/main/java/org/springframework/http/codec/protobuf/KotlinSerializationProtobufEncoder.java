 ...
 * @since 5.3
 */
public class KotlinSerializationProtobufEncoder extends KotlinSerializationBinaryEncoder {

	public KotlinSerializationProtobufEncoder() {
		this(ProtoBuf.Default);
	}

	public KotlinSerializationProtobufEncoder(final ProtoBuf protobuf) {
