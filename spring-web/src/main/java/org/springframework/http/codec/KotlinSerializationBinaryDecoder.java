...
/**
 * Decode a byte stream convert to Objects with
 ...
 * @since 5.3
 */
public class KotlinSerializationBinaryDecoder extends AbstractKotlinSerializationDecoder {
	...
	public KotlinSerializationBinaryDecoder(final BinaryFormat format, final MimeType... supportedMimeTypes) {
	...
	public Mono<Object> decodeToMono(final Publisher<DataBuffer> inputStream, final ResolvableType elementType,
		...
		return this.byteArrayDecoder
				...
				.map(byteArray -> this.format.decodeFromByteArray(serializer(elementType.getType()), byteArray));
	}
