...
/**
 * Fastjson 2.x converter tests.
 *
 * @author miao enkui
 */
public class FastjsonHttpMessageConverterTests {
	private final FastjsonHttpMessageConverter converter = new FastjsonHttpMessageConverter();
