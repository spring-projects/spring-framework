...
import static org.springframework.web.client.support.ExceptionMessageExtractor.*;

public class ExceptionMessageExtractorTests {

	@Test
	public void shouldGetSimpleExceptionMessage() {
		String actual = getExceptionMessage(HttpStatus.NOT_FOUND, "Not Found", null, null, null, null);
	...
	public void shouldGetCompleteMessageWithoutBody() {
		String actual = getExceptionMessage(HttpStatus.NOT_FOUND, "Not Found", null, null, URI.create("http://localhost:8080/my-endpoint"), GET);
	...
	public void shouldGetCompleteMessageWithShortAsciiBodyNoCharset() {
		...
		String actual = getExceptionMessage(HttpStatus.NOT_FOUND, "Not Found", responseBody.getBytes(), null, URI.create("http://localhost:8080/my-endpoint"), GET);
	...
	public void shouldGetCompleteMessageWithShortAsciiBodyUtfCharset() {
		...
		String actual = getExceptionMessage(HttpStatus.NOT_FOUND, "Not Found", responseBody.getBytes(), UTF_8, URI.create("http://localhost:8080/my-endpoint"), GET);
	...
	public void shouldGetCompleteMessageWithShortUtfBodyNoCharset() {
		...
		String actual = getExceptionMessage(HttpStatus.NOT_FOUND, "Not Found", responseBody.getBytes(UTF_8), null, URI.create("http://localhost:8080/my-endpoint"), GET);
	...
	public void shouldGetCompleteMessageWithLongUtfBodyUtfCharset() {
		...
		String actual = getExceptionMessage(HttpStatus.NOT_FOUND, "Not Found", responseBody.getBytes(UTF_8), UTF_8, URI.create("http://localhost:8080/my-endpoint"), GET);
