...
import org.springframework.http.converter.json.JacksonSerializationValue;
...
public class RestTemplateIntegrationTests extends AbstractJettyServerTestCase {
	...
	public void jsonPostForObjectWithJacksonView() throws URISyntaxException {
		...
		JacksonSerializationValue jsv = new JacksonSerializationValue(bean, MyJacksonView1.class);
