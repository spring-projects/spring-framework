 ...
 * of the Java Language Specification</a>, with the addiction of BigDecimals management:
 *
 * <p>If any of the operands is of a reference type, unboxing conversion (Section 5.1.8) is performed. Then:<br>
 * If either operand is of type BigDecimal, the other is converted to BigDecimal.<br>
