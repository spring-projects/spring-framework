...
are hard to interpret consistently. In the present, and for REST services, the `Accept`
...
resolution using JSP HTML templates and Jackson as a default `View` for
JSON rendering:
