...
years but is no longer maintained. The
https://github.com/JSteunou/webstomp-client[JSteunou/webstomp-client] was the most
actively maintained and evolving successor of that library until 2018. The following example code
is based on it:
