...
==== HTTP Streaming
[.small]#<<webmvc.adoc#mvc-ann-async-http-streaming,Same in Spring MVC>>#
...
[[webflux-filters]]
=== Filters
[.small]#<<webmvc.adoc#filters,Same in Spring MVC>>#
...
==== Forwarded Headers
[.small]#<<webmvc.adoc#forwarded-headers,Same in Spring MVC>>#
...
==== CORS
[.small]#<<webmvc.adoc#cors,Same in Spring MVC>>#
...
=== Exceptions
[.small]#<<webmvc.adoc#container-error-page,Same in Spring MVC>>#
...
== DispatcherHandler
[.small]#<<webmvc.adoc#dispatcherservlet,Same in Spring MVC>>#
...
=== Special bean types
[.small]#<<webmvc.adoc#special-bean-types,Same in Spring MVC>>#
...
=== WebFlux Config
[.small]#<<webmvc.adoc#web-mvc-config,Same in Spring MVC>>#
...
=== Processing
[.small]#<<webmvc.adoc#processing,Same in Spring MVC>>#
...
=== Exceptions
[.small]#<<webmvc.adoc#exceptions,Same in Spring MVC>>#
...
=== View Resolution
[.small]#<<webmvc.adoc#view-resolution,Same in Spring MVC>>#
...
==== Handling
[.small]#<<webmvc.adoc#handling,Same in Spring MVC>>#
...
==== Redirecting
[.small]#<<webmvc.adoc#redirecting,Same in Spring MVC>>#
...
==== Content negotiation
[.small]#<<webmvc.adoc#content-negotiation,Same in Spring MVC>>#
...
[.small]#<<webmvc.adoc#annotated-controllers,Same in Spring MVC>>#
...
=== @Controller
[.small]#<<webmvc.adoc#declaration,Same in Spring MVC>>#
...
`@RestController` is a link:../core/core-beans.adoc#meta-annotations[composed annotation] that is
...
=== Request Mapping
[.small]#<<webmvc.adoc#request-mapping,Same in Spring MVC>>#
...
==== URI Patterns
[.small]#<<webmvc.adoc#uri-patterns,Same in Spring MVC>>#
...
==== Pattern Comparison
[.small]#<<webmvc.adoc#pattern-comparison,Same in Spring MVC>>#
...
[.small]#<<webmvc.adoc#consumable-media-types,Same in Spring MVC>>#
...
[.small]#<<webmvc.adoc#producible-media-types,Same in Spring MVC>>#
...
[.small]#<<webmvc.adoc#parameters-headers,Same in Spring MVC>>#
...
==== HTTP HEAD, OPTIONS
[.small]#<<webmvc.adoc#http-head-options,Same in Spring MVC>>#
...
==== Custom Annotations
[.small]#<<webmvc.adoc#custom-annotations,Same in Spring MVC>>#

Spring WebFlux supports the use of link:../core/core-beans.adoc#meta-annotations[composed annotations]
...
[[webflux-ann-methods]]
=== Handler methods
[.small]#<<webmvc.adoc#handler-methods,Same in Spring MVC>>#
...
==== Method arguments
[.small]#<<webmvc.adoc#method-arguments,Same in Spring MVC>>#
...
==== Return values
[.small]#<<webmvc.adoc#return-values,Same in Spring MVC>>#
...
==== Type Conversion
[.small]#<<webmvc.adoc#type-conversion,Same in Spring MVC>>#
...
Link:../core/core-validation.adoc#spring-field-formatting[Spring Field Formatting].


[[webflux-ann-matrix-variables]]
==== Matrix variables
[.small]#<<webmvc.adoc#matrix-variables,Same in Spring MVC>>#
...
==== @RequestParam
[.small]#<<webmvc.adoc#requestparam,Same in Spring MVC>>#
...
==== @RequestHeader
[.small]#<<webmvc.adoc#requestheader,Same in Spring MVC>>#
...
==== @CookieValue
[.small]#<<webmvc.adoc#cookievalue,Same in Spring MVC>>#
...
==== @ModelAttribute
[.small]#<<webmvc.adoc#modelattribute,Same in Spring MVC>>#
...
Link:../core/core-validation.adoc[Validation]. For more on customizing data binding see
...
Link:../core/core-validation.adoc#spring-validation[Bean validation] and
Link:../core/core-validation.adoc[Spring validation]). For example:
...
==== @SessionAttributes
[.small]#<<webmvc.adoc#sessionattributes,Same in Spring MVC>>#
...
==== @SessionAttribute
[.small]#<<webmvc.adoc#sessionattribute,Same in Spring MVC>>#
...
==== @RequestAttribute
[.small]#<<webmvc.adoc#requestattribute,Same in Spring MVC>>#
...
==== Multipart
[.small]#<<webmvc.adoc#multipart,Same in Spring MVC>>#
...
==== @RequestBody
[.small]#<<webmvc.adoc#requestbody,Same in Spring MVC>>#
...
==== HttpEntity
[.small]#<<webmvc.adoc#httpentity,Same in Spring MVC>>#
...
==== @ResponseBody
[.small]#<<webmvc.adoc#responsebody,Same in Spring MVC>>#
...
==== ResponseEntity
[.small]#<<webmvc.adoc#responseentity,Same in Spring MVC>>#
...
[.small]#<<webmvc.adoc#jackson-json,Same in Spring MVC>>#
...
=== Model
[.small]#<<webmvc.adoc#model,Same in Spring MVC>>#
...
[[webflux-ann-initbinder]]
=== DataBinder
[.small]#<<webmvc.adoc#databinder,Same in Spring MVC>>#
...
==== REST API exceptions
[.small]#<<webmvc.adoc#rest-api-exceptions,Same in Spring MVC>>#
...
=== Controller Advice
[.small]#<<webmvc.adoc#controller-advice,Same in Spring MVC>>#
...
as Spring beans via Link:../core/core-beans.adoc#enabling-component-scanning-with-scanstring[component scanning].
...
[[mvc-uri-building]]
== URI Links
[.small]#<<webmvc.adoc#uri-links,Same in Spring MVC>>#
...
== Web Security
[.small]#<<webmvc.adoc#web-security,Same in Spring MVC>>#
...
[[webflux-config]]
== WebFlux Config
[.small]#<<webmvc.adoc#mvc-config,Same in Spring MVC>>#
...
[.small]#<<webmvc.adoc#enable-mvc-config,Same in Spring MVC>>#
...
=== WebFlux config API
[.small]#<<webmvc.adoc#mvc-config-api,Same in Spring MVC>>#
...
[.small]#<<webmvc.adoc#type-conversion-1,Same in Spring MVC>>#
...
[NOTE]
====
See Link:../core/core-validation.adoc#formatterregistrar-spi[FormatterRegistrar SPI]
...
=== Validation
[.small]#<<webmvc.adoc#validation,Same in Spring MVC>>#

By default if Link:../core/core-validation.adoc#overview-of-the-jsr-303-bean-validation-api[Bean Validation] is present
on the classpath -- e.g. Hibernate Validator, the `LocalValidatorFactoryBean` is registered
as a global Link:../core/core-validation.adoc#validation-using-springs-validator-interface[Validator] for use with `@Valid` and `Validated` on
...
[.small]#<<webmvc.adoc#content-types,Same in Spring MVC>>#
...
=== HTTP message codecs
[.small]#<<webmvc.adoc#message-converters,Same in Spring MVC>>#
...
=== View resolvers
[.small]#<<webmvc.adoc#view-resolvers,Same in Spring MVC>>#
...
=== Static resources
[.small]#<<webmvc.adoc#static-resources-1,Same in Spring MVC>>#
...
=== Path Matching
[.small]#<<webmvc.adoc#path-matching,Same in Spring MVC>>#
...
[.small]#<<webmvc.adoc#advanced-java-config,Same in Spring MVC>>#
...
[[webflux-http2]]
== HTTP/2
[.small]#<<webmvc.adoc#http2,Same in Spring MVC>>#
