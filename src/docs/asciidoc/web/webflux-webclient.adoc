...
[[webflux-client-builder-apache]]
=== Apache

The following example shows how to customize Apache `HttpClient` settings:
...
----
	...
	ClientHttpConnector connector = new ApacheClientHttpConnector(client);
