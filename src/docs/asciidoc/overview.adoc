...
and we have an https://spring.io/questions[questions page] that lists the suggested tags to use.
...
Framework by creating an https://projects.spring.io/spring-boot/[Spring Boot]-based
