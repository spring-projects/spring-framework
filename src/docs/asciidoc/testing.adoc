...
----
	// ApplicationContext will be loaded from BaseConfig
	@SpringJUnitConfig(BaseConfig::class.java) <1>
	open class BaseTest {
		// class body...
	}

	// ApplicationContext will be loaded from BaseConfig and ExtendedConfig
	@SpringJUnitConfig(ExtendedConfig::class.java) <2>
	class ExtendedTest : BaseTest() {
		// class body...
	}
----
...
----
	// ApplicationContext will be initialized by BaseInitializer
	@SpringJUnitConfig(initializers = BaseInitializer::class.java) <1>
	open class BaseTest {
		// class body...
	}
	...
	// ApplicationContext will be initialized by BaseInitializer
	// and ExtendedInitializer
	@SpringJUnitConfig(initializers = ExtendedInitializer::class.java) <2>
	class ExtendedTest : BaseTest() {
		// class body...
	}
----
...
.Kotlin
----
	@ExtendWith(SpringRunner::class.java)
	// ApplicationContext will be loaded from "classpath:/app-config.xml"
	@ContextConfiguration("/app-config.xml")
	@ActiveProfiles("dev")
	class TransferServiceTest {
...
----
    ...
    @BeforeEach
    fun setup(contect: WebApplicationContext) {
        driver = MockMvcHtmlUnitDriverBuilder
                .webAppContextSetup(context)
                .build()
    }
