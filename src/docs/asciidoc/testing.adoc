...
.Kotlin
----
	@ContextConfiguration(classes = [TestConfig::class.java]) <1>
...
.Kotlin
----
	@ContextConfiguration(initializers = [CustomContextIntializer::class.java]) <1>
...
.Kotlin
----
	@ContextConfiguration(locations = ["/test-context.xml"], loader = [CustomContextLoader::class.java]) <1>
...
----
    @WebAppConfiguration
	@ContextHierarchy(
		@ContextConfiguration(classes = AppConfig::class.java),
		@ContextConfiguration(classes = WebConfig::class.java))
...
----
	@DirtiesContext(methodMode = BEFORE_METHOD) <1>
	@Test
	public fun testProcessWhichRequiresFreshAppCtx() {
		// some logic that requires a new Spring container
	}
----
...
----
	@DirtiesContext <1>
	@Test
	public fun testProcessWhichDirtiesAppCtx() {
		// some logic that results in the Spring container being dirtied
	}
----
...
----
	@ContextHierarchy(
            ContextConfiguration("/parent-config.xml"),
            ContextConfiguration("/child-config.xml"))
    open class BaseTests// class body...
...
----
	@ContextConfiguration
    @TestExecutionListeners(CustomTestExecutionListener::class.java, AnotherTestExecutionListener::class.java) <1>
...
----
	@Commit <1>
	@Test
	public fun testProcessWithoutRollback() {
		// ...
	}
----
...
.Kotlin
----
	@SpringJUnitConfig(TestConfig::class.java)
	@Sql("/test-schema.sql")
	@SqlMergeMode(MERGE) <1>
	class UserTests {
...
----
    @IfProfileValue(name="java.vendor", value="Oracle Corporation") <1>
	@Test
	public fun testProcessWhichRunsOnlyOnOracleJvm() {
		// some logic that should run only on Java VMs from Oracle Corporation
	}
----
...
----
    @IfProfileValue(name="test-groups", values=["unit-tests", "integration-tests"]) <1>
	@Test
	public fun testProcessWhichRunsForUnitOrIntegrationTestGroups() {
		// some logic that should run only for unit and integration test groups
	}
----
...
.Kotlin
----
    @ProfileValueSourceConfiguration(CustomProfileValueSource::class.java) <1>
...
----
    @Timed(millis = 1000) <1>
	public fun testProcessWithOneSecondTimeout() {
		// some logic that should not take longer than 1 second to execute
	}
----
...
----
    @Repeat(10) <1>
	@Test
	public fun testProcessRepeatedly() {
		// ...
	}
----
...
.Kotlin
----
    @SpringJUnitConfig(TestConfig::class.java) <1>
	class ConfigurationClassJUnitJupiterSpringTests {
		// class body...
	}
----
...
.Kotlin
----
    @SpringJUnitWebConfig(TestConfig::class.java) <1>
	class ConfigurationClassJUnitJupiterSpringWebTests {
		// class body...
	}
----
...
----
	...
	@ActiveProfiles("dev")
	@Transactional
	public annotation class TransactionalDevTestConfig { }
----
...
----
	...
	@Tag("integration-test") // org.junit.jupiter.api.Tag
	@Test // org.junit.jupiter.api.Test
	public annotation class TransactionalIntegrationTest { }
----
...
----
	@ContextConfiguration
	@TestExecutionListeners([
		MyCustomTestExecutionListener::class.java,
		ServletTestExecutionListener::class.java,
		DirtiesContextBeforeModesTestExecutionListener::class.java,
		DependencyInjectionTestExecutionListener::class.java,
		DirtiesContextTestExecutionListener::class.java,
		TransactionalTestExecutionListener::class.java,
		SqlScriptsTestExecutionListener::class.java
	])
	public class MyTest {
		// class body...
	}
...
----
    @ContextConfiguration
	@TestExecutionListeners(
		listeners = MyCustomTestExecutionListener::class.java,
		mergeMode = MERGE_WITH_DEFAULTS
	)
	public class MyTest {
		// class body...
...
----
    @RunWith(SpringRunner::class.java)
	// ApplicationContext will be loaded from AppConfig and TestConfig
	@ContextConfiguration(classes = [AppConfig::class.java, TestConfig::class.java]) <1>
	public class MyTest {
		// class body...
	}
----
...
----
	...
	// and initialized by TestAppCtxInitializer
	@ContextConfiguration(
		classes = TestConfig::class.java,
		initializers = TestAppCtxInitializer::class.java) <1>
	class MyTest {
		// class body...
	}
----
...
----
	...
	// ApplicationContext will be initialized by EntireAppInitializer
	// which presumably registers beans in the context
	@ContextConfiguration(initializers = EntireAppInitializer::class.java) <1>
	class MyTest {
		// class body...
	}
----
...
.Kotlin
----
	@RunWith(SpringRunner::calss.java)
	// ApplicationContext will be loaded from BaseConfig
	@ContextConfiguration(classes = BaseConfig::class.java) <1>
	open class BaseTest {
		// class body...
	}

	// ApplicationContext will be loaded from BaseConfig and ExtendedConfig
	@ContextConfiguration(classes = ExtendedConfig::class.java) <2>
	class ExtendedTest : BaseTest() {
		// class body...
	}
----
...
----
	@RunWith(SpringRunner::class.java)
	// ApplicationContext will be initialized by BaseInitializer
	@ContextConfiguration(initializers = BaseInitializer::class.java) <1>
	open class BaseTest {
		// class body...
	}
	...
	// ApplicationContext will be initialized by BaseInitializer
	// and ExtendedInitializer
	@ContextConfiguration(initializers = ExtendedInitializer::class.java) <2>
	class ExtendedTest : BaseTest() {
		// class body...
	}
----
...
----
	...
	class TransferServiceTest {
		...
		@Test
		public fun testTransferService() {
			// test the transferService
		}
	}
----
...
----
    ...
    @ContextConfiguration(
        classes = [
            TransferServiceConfig::class.java, StandaloneDataConfig::class.java,
            JndiDataConfig::class.java, DefaultDataConfig::class.java])
    @ActiveProfiles("dev")
    class TransferServiceTest {
...
----
	@RunWith(SpringRunner::class.java)
	@ContextConfiguration(classes = [
			TransferServiceConfig::class.java,
...
----
	// "dev" profile overridden programmatically via a custom resolver
	@ActiveProfiles(
		resolver = OperatingSystemActiveProfilesResolver::class.java,
		inheritProfiles = false)
	class TransferServiceTest : AbstractIntegrationTest() {
		// test body
	}
...
----
    ...
    internal override fun resolve(testClass: Class<*>): Array<String> {
        val profile: String = .....
        // determine the value of profile based on the operating system
...
----
	...
	@WebAppConfiguration
	@ContextHierarchy([
		@ContextConfiguration(classes = TestAppConfig::class.java),
		@ContextConfiguration(classes = WebConfig::class.java)
	])
...
----
	...
	public class ExtendedTests : BaseTests() {}
----
--
...
----
    ...
    class HibernateTitleRepositoryTests {
        ...
        // this instance will be dependency injected by type
        @Autowired
        private lateinit var titleRepository: HibernateTitleRepository
...
----
	...
	class SessionScopedBeanTests {
		...
		@Autowired lateinit var serService:UserService
		@Autowired lateinit var session:MockHttpSession

		@Test
        @Throws(Exception::class)
		public fun sessionScope() {
			session.setAttribute("theme", "blue")
...
----
	@RunWith(SpringRunner::class.java)
    @ContextConfiguration(classes = [TestConfig::class.java])
    @Transactional
...
.Kotlin
----
	@SpringJUnitConfig(TestDatabaseConfig::class.java)
    @Transactional
    class TransactionalSqlScriptsTests @Autowired
...
----
	// Instructs Spring to register the SpringExtension with JUnit
	// Jupiter and load a WebApplicationContext from TestWebConfig.class
	@SpringJUnitWebConfig(TestWebConfig::class.java)
	class SimpleWebTests {
...
----
	...
	class OrderServiceIntegrationTests {
		...
		@Test
		fun deleteOrder(orderService: OrderService) {
			// use orderService from the test's ApplicationContext
		}
	}
----
...
----
	...
	class OrderServiceIntegrationTests {
		...
		@RepeatedTest(10)
		fun placeOrderRepeatedly(repetitionInfo:RepetitionInfo, orderService:OrderService) {
...
.Kotlin
----
	mockMvc.perform(multipart("/doc").file("a1", "ABC".toByteArray(charset("UTF8"))))
----
...
.Kotlin
----
	var mvcResult = mockMvc.perform(post("/persons")).andExpect(status().isOk()).andReturn()
	// ...
----
...
----
    ...
    Throws(Exception::class)
    public fun test() {
    var mvcResult = this.mockMvc.perform(get("/path"))
        .andExpect(status().isOk()) <1>
        .andExpect(request().asyncStarted()) <2>
        .andExpect(request().asyncResult("body")) <3>
        .andReturn()
...
.Kotlin
----
	var createMessage = post("/messages/")
			.param("summary", "Spring Rocks")
			.param("text", "In case you didn't know, Spring Rocks!")
...
----
	...
	val createMessage = post("/messages/")
			.param(summaryParamName, "Spring Rocks")
			.param(textParamName, "In case you didn't know, Spring Rocks!")
...
.Kotlin
----
	public fun createMessage(currentPage: HtmlPage, summary:String, text:String) :HtmlPage{
		setSummary(currentPage, summary);
		// ...
	}

	public fun setSummary(currentPage:HtmlPage , summary:String ) {
		val summaryInput = currentPage.getHtmlElementById("summary")
		summaryInput.setValueAttribute(summary)
	}
----
...
.Kotlin
----
	class CreateMessagePage(internal val currentPage: HtmlPage) {

    val summaryInput: HtmlTextInput

    val submit: HtmlSubmitInput
    ...
    fun <T> createMessage(summary: String, text: String): T {
        ...
        val error = CreateMessagePage.at(result)
...
.Kotlin
----
	class CreateMessagePage(driver: WebDriver) : AbstractPage(driver) { // <1>

    // <2>
    private val summary: WebElement? = null
    private val text: WebElement? = null
...
----
	...
	this.restTemplate = RestTemplate(MockMvcClientHttpRequestFactory(mockMvc))
