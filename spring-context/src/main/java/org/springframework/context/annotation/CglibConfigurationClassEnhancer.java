 ...
 */
class CglibConfigurationClassEnhancer implements ConfigurationClassEnhancer {
	...
	private static final Log logger = LogFactory.getLog(CglibConfigurationClassEnhancer.class);
	 ...
	 * @see Bean
	 * @see CglibConfigurationClassEnhancer
	 */
