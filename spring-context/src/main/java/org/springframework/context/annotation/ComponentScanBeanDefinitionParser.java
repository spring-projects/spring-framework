...
public class ComponentScanBeanDefinitionParser implements BeanDefinitionParser {
	...
	protected TypeFilter createTypeFilter(Element element, @Nullable ClassLoader classLoader,
		...
		return switch (filterType) {
			case "annotation" -> new AnnotationTypeFilter((Class<Annotation>) ClassUtils.forName(expression, classLoader));
			...
			case "custom" -> resolveTypeFilter(classLoader, expression);
			default -> throw new IllegalArgumentException("Unsupported filter type: " + filterType);
		};
	}

	private static TypeFilter resolveTypeFilter(ClassLoader classLoader, String expression) throws ClassNotFoundException {
