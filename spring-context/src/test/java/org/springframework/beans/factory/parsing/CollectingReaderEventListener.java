...
public class CollectingReaderEventListener implements ReaderEventListener {
	...
	private final Map<String, ComponentDefinition> componentDefinitions = new LinkedHashMap<String, ComponentDefinition>(8);

	private final Map<String, List<AliasDefinition>> aliasMap = new LinkedHashMap<String, List<AliasDefinition>>(8);
