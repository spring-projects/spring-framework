...
import org.springframework.context.BeanRegistrationDsl.*
import org.springframework.context.support.GenericApplicationContext


class BeanRegistrationDslTests {
	
	@Test
	fun `Register beans with the functional Kotlin DSL`() {
		val beans = beans { 
			bean<Foo>()
	...
	@Test
	fun `Register beans using profile condition with the functional Kotlin DSL`() {
		val beans = beans {
			bean<Foo>()
			bean<Bar>("bar")
			profile("baz") {
	...
	@Test
	fun `Register beans using environment condition with the functional Kotlin DSL`() {
		val beans = beans {
			bean<Foo>()
			bean<Bar>("bar")
