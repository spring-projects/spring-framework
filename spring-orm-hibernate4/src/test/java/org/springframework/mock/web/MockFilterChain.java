 ...
 *
 * <p>A {@link org.springframework.mock.web.MockFilterChain} can be configured with one or more filters and a
...
public class MockFilterChain implements FilterChain {
	...
	/**
	 * Register a single do-nothing {@link javax.servlet.Filter} implementation. The first
	 ...
	 *
	 * @param servlet the {@link javax.servlet.Servlet} to invoke in this {@link javax.servlet.FilterChain}
	 * @param filters the {@link javax.servlet.Filter}'s to invoke in this {@link javax.servlet.FilterChain}
	 * @since 3.2
	 */
	...
	/**
	 * Invoke registered {@link javax.servlet.Filter}s and/or {@link javax.servlet.Servlet} also saving the
	...
	/**
	 * Reset the {@link org.springframework.mock.web.MockFilterChain} allowing it to be invoked again.
	 */
	public void reset() {
		this.request = null;
		this.response = null;
