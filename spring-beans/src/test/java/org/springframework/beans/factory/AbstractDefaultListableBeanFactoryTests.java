 ...
 */
public abstract class AbstractDefaultListableBeanFactoryTests {

	private static final Log factoryLog = LogFactory.getLog(DefaultListableBeanFactory.class);

	public abstract DefaultListableBeanFactory getInstance();

	public abstract DefaultListableBeanFactory getInstance(@Nullable BeanFactory parentBeanFactory);
	...
	public void testUnreferencedSingletonWasInstantiated() {
		...
		DefaultListableBeanFactory lbf = getInstance();
	...
	public void testEmpty() {
		ListableBeanFactory lbf = getInstance();
	...
	public void testCanReferenceParentBeanFromChildViaAlias() {
		...
		DefaultListableBeanFactory factory = getInstance();
	...
	public void testArrayPropertyWithAutowiring() throws MalformedURLException {
		DefaultListableBeanFactory bf = getInstance();
	...
	public void testGetBeanByTypeDefinedInParent() {
		DefaultListableBeanFactory parent = getInstance();
		RootBeanDefinition bd1 = new RootBeanDefinition(TestBean.class);
		parent.registerBeanDefinition("bd1", bd1);
		DefaultListableBeanFactory lbf = getInstance(parent);
	...
	public void testInitSecurityAwarePrototypeBean() {
		final DefaultListableBeanFactory lbf = getInstance();
