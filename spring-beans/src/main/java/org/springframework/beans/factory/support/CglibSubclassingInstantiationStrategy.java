 ...
 * <p> 如果方法需要被容器重写以实现<em>方法注入<em>，则使用CGLIB动态生成子类
 *
 * @author Rod Johnson
...
public class CglibSubclassingInstantiationStrategy extends SimpleInstantiationStrategy {
	 ...
	 * CGLIB回调数组中用于传递行为的索引，在这种情况下，子类不会覆盖原始类
	 */
	 ...
	 * CGLIB回调数组中应重写以提供<em>方法查找<em>的方法的索引
	 */
	 ...
	 * CGLIB回调数组中应使用泛型<em>方法替换器<em>功能覆盖的方法的索引
	 */
