...
public abstract class AbstractBeanDefinition extends BeanMetadataAttributeAccessor
	...
	/**
	 * autowire-candidate属性设置为false，这样容器在查找自动装配对象时，将不考虑该bean，即它不会被考虑作为其他bean自动装配的候选者，但是该bean本身
	 * 还可以使用自动装配来注入其他的bean
	 */
	private boolean autowireCandidate = true;

	/**
	 * 自动装配出现多个候选者时，将作为首选者，对应bean属性primary
	 */
	 ...
	 * <bean id="instanceFactoryBean" class="xxx.InstanceFactoryBean"/>
	...
	/**
	 * 是否是用户自定义而不是应用程序本身自定义的，创建AOP的时候为true，程序设置
	 */
