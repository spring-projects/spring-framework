...
The `ClientHttpRequestFactories` utility class can be used to create `ClientHttpRequestFactory` instances. Settings like connect and read timeouts can be applied using the `ClientHttpRequestFactorySettings` class.
