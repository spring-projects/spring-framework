...
(and WildFly). As of Jakarta WebSocket 2.2, a standard request upgrade strategy is available
which Spring chooses on Jakarta EE 11 based web containers such as Tomcat 11.0 and Jetty 12.1.
