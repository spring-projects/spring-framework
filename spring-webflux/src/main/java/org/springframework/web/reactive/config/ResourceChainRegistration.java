...
public class ResourceChainRegistration {
	...
	public ResourceChainRegistration addResolver(ResourceResolver resolver) {
		...
		else if (resolver instanceof org.springframework.web.reactive.resource.WebJarsResourceResolver ||
	...
	protected List<ResourceResolver> getResourceResolvers() {
		if (!this.hasPathResolver) {
			...
			if (isWebJarVersionLocatorPresent && !this.hasWebjarsResolver) {
				...
				result.add(new org.springframework.web.reactive.resource.WebJarsResourceResolver());
			}
