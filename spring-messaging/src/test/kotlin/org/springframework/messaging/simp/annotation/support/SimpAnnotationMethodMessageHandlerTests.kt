 ...
 */
open class KotlinSimpAnnotationMethodMessageHandlerTests {
    ...
    fun setup() {
        ...
        val brokerTemplate = SimpMessagingTemplate(this.channel)
        brokerTemplate.messageConverter = this.converter

        messageHandler = TestSimpAnnotationMethodMessageHandler(brokerTemplate, this.channel, this.channel)
    ...
    fun nullableHeaderWithHeader() {
        ...
        messageHandler.registerHandler(this.testController)
        messageHandler.handleMessage(message)
        assertNull(testController.exception)
        assertEquals("bar", this.testController.header)
    }
