 ...
 *
 * <p>AspectJ自动代理Bean定义解析器(AspectJAutoProxyBeanDefinitionParser)
 * <p>{@code aspectj-autoproxy}标签的{@link BeanDefinitionParser},
 * 启用在{@link org.springframework.beans.factory.BeanFactory}中找到的@AspectJ-style aspects的自动应用
 *
 * @author Rob Harrop
