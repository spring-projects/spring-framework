...
public class AspectJAwareAdvisorAutoProxyCreator extends AbstractAdvisorAutoProxyCreator {
	...
	protected boolean shouldSkip(Class<?> beanClass, String beanName) {
		...
		boolean isAspectAdvisor = candidateAdvisors.stream()
				.anyMatch(advisor -> advisor instanceof AspectJPointcutAdvisor pointcutAdvisor &&
						pointcutAdvisor.getAspectName().equals(beanName)
				);

		return isAspectAdvisor || super.shouldSkip(beanClass, beanName);
	}
